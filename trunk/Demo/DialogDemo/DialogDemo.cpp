// DialogDemo.cpp : Defines the class behaviors for the application.
//
...
// The one and only CDialogDemoApp object

CDialogDemoApp theApp;


// CDialogDemoApp initialization
